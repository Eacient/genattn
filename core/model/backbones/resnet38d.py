...
def convert_mxnet_to_torch(filename='pretrained/ilsvrc-cls_rna-a1_cls1000_ep-0001.params'):
    import mxnet
...
def build_resnet38d_backbone():
    return Net()

if __name__ == "__main__":
    resnet38 = build_resnet38d_backbone()
    n_parameters = sum(p.numel() for p in resnet38.parameters())
    print('number of params:', n_parameters)
    from torchstat import stat
    print(stat(resnet38, (3,224,224)))